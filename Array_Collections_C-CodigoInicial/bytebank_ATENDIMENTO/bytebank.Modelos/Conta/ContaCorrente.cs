namespace bytebank.Modelos.Conta
{
	public class ContaCorrente : IComparable<ContaCorrente>
	{
		...
		public ContaCorrente(int numero_agencia, string numero_conta, string nome, string cpf, string profissao)
		{
			Numero_agencia = numero_agencia;
			Conta = numero_conta;//Guid.NewGuid().ToString().Substring(0, 8);
        ...
        public int CompareTo(ContaCorrente? other)
        {
			...
			{
				return this._conta.CompareTo(other._conta);	
			}
        }
    }
